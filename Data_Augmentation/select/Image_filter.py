...
def extract_images_and_labels(images_folder, labels_folder, output_folder):
    ...
    for image_file in image_files:
        ...
        # 检查标签文件是否包含五号装甲板类别
        has_armor5 = any(line.startswith('5 ') or line.startswith('10 ') for line in lines)
...
# 示例用法:
dataset_folder = r'G:\Radar_datasets\yolo\radar_full'  # 替换为实际的数据集文件夹路径
output_folder = r'G:\Radar_datasets\yolo\after_filter_class5'  # 替换为所需的输出文件夹路径

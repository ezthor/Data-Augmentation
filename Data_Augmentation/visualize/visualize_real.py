...
# 将类yolo格式，但是是用真实像素值而非百分比的图片可视化,n下一张，p上一张，d删除图片和标注
...
if __name__ == "__main__":
    image_folder = r"G:\Radar_datasets\yolo\extract_try_roi_blue5\images\train"  # 图像文件夹路径
    annotation_folder = r"G:\Radar_datasets\yolo\extract_try_roi_blue5\labels\train"  # 标注文件夹路径
